...
static NSString * const FTP_ADDRESS = @"ftp://192.168.36.33";
static NSString * const USERNAME = @"hhly";
static NSString * const PASSWORD = @"admin";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 2:
        {
            ...
            request.serverURL = [[NSURL URLWithString:FTP_ADDRESS]URLByAppendingPathComponent:@"1111.jpg"];
